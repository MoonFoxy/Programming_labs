...
int main()
{
    double input;                   // Число которое будет представлено в двоичном итерпретации, можешь изменить, ставь что пожелаешь
    ...
    cscanf("%f", &input);           // Ввод числа с плавающей точкой
    scroll(7, 0, 9, 24, 19, 54, 0); // Скроллиг сверху вниз
    for (int i = 0; i < 128; i++)   // т.к. 8 цветов фона + 16 цветов текста, всего 128 комбинациий, отсчет с 0 до 127
    {
        ...
        scroll(7, 3, 9, 24, 19, 54, 0); /* Cкроллиг
